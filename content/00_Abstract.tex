...
À la question \textit{"Sommes-nous seuls dans l'univers ?"}, l'analyse et la caractérisation d'atmosphère d'exoplanètes pourrait bien y répondre. En effet, la recherche de vie ailleurs étant l'une des plus grandes questions astronomiques actuelles, ces domaines jouent un rôle crucial dans la compréhension de notre singularité dans l'univers.
...
La méthode que nous utiliserons ici pour surmonter ce problème est (\textbf{l'apodisation}).
